...
module.exports = (req, res, next) => {
    ...
    if (req.body.bpm <60) {
        var message = "This is SMS Message From Heart Rate Monitoring System. Your Patient with ID="+req.body.uid+" his Heart Rate is  "+req.body.bpm+" is Getting Lower Please, try to Call him, Thank You";
